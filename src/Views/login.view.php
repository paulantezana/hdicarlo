    ...
    <div class="Login SnCard">
        <div class="SnCard-body">
            ...
            <form action="" method="post" class="SnForm">
                ...
                <button type="submit" class="SnBtn block primary lg radio" name="commit"><i class="fas fa-sign-in-alt SnMr-2"></i>Iniciar sesión</button>
                <p style="text-align: center">
                    <a href="<?= URL_PATH ?>/user/forgot"> ¿Olvido su contraseña?</a> ó <br>
                    <a href="<?= URL_PATH ?>/user/register">Registrarse</a>
                </p>
            </form>
        </div>
    </div>
