        ...
        <div class="m-col-3">
            <form action="" class="SnForm" novalidate id="companyForm" onsubmit="companySubmit(event)">
                ...
                <div class="SnForm-item">
                    ...
                    <div class="SnControl-wrapper">
                        <i class="fas fa-phone-volume SnControl-prefix"></i>
                        <input type="text" class="SnForm-control SnControl" id="companyTelephone" value="<?= $parameter['company']['telephone'] ?>">
                    </div>
                </div>
                <div class="SnForm-item">
                    ...
                    <div class="SnControl-wrapper">
                        ...
                        <input type="text" class="SnForm-control SnControl" id="companyUrlWeb" value="<?= $parameter['company']['url_web'] ?>">
                    </div>
                </div>
                <div class="SnForm-item">
...
<script src="<?= URL_PATH ?>/assets/build/script/admin/company.js"></script>
