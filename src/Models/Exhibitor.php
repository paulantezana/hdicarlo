...
class Exhibitor extends Model
{
    ...
    public function insert(array $exhibitor, int $userId)
    {
        try {
            ...
            $stmt->bindValue(':code', $exhibitor['code']);
            $stmt->bindValue(':address', $exhibitor['address']);
            $stmt->bindValue(':size_id', $exhibitor['sizeId']);
            $stmt->bindValue(':country_id', $exhibitor['countryId']);
            $stmt->bindValue(':geo_level_1_id', $exhibitor['geoLevel1Id']);
            $stmt->bindValue(':geo_level_2_id', $exhibitor['geoLevel2Id']);
